<script>
    ...
    let {requiresConfirmation} = $props();
    ...
    {#snippet content()}
        ...
        {#if twoFactorEnabled}
                ...
                {#if confirming}
                    <div class="mt-4">
                        ...
                        <Input id="code" name="code" inputmode="numeric" autofocus autocomplete="one-time-code"
                               bind:value={$confirmationForm.code} class="mt-1"/>
            ...
            {#if recoveryCodes.length > 0 && !confirming}
                ...
                <div
                    class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 rounded-lg select-all dark:bg-gray-950 dark:text-white">
