...
<dialog bind:this={dialog} class="m-auto sm:rounded-2xl">
    <div
        class={clsx('w-full text-left rounded-t-3xl shadow-xl overflow-hidden transform transition-all ring-contrast sm:rounded-2xl', getSizeClasses())}>
        <div
