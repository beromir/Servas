...
<div class={['sm:grid sm:grid-cols-5 sm:gap-4 sm:items-start',
    ...
    <div class="mt-1 sm:mt-0 sm:col-span-4">
        <input id={name} {name} {type} {...rest} {value} oninput={(e) => value = e.target.value}
               class="block max-w-xl w-full shadow-xs focus:ring-primary-500 focus:border-primary-500 sm:text-sm border-gray-400 rounded-md dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 dark:border-gray-600">
        {#if error}
