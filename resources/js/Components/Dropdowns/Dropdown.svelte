...
{#if showDropdown}
    <div use:clickOutside onclick_outside={() => showDropdown = false} {...rest}
         ...
         class={clsx(rest.class, openingDirection === 'right' ? 'left-0 origin-top-left' : 'right-0 origin-top-right', 'absolute z-10 mt-6 w-44 divide-y divide-gray-200 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none md:w-56 dark:bg-gray-900 dark:ring-contrast dark:divide-gray-700')}
