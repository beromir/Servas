        ...
        <div in:scale={{duration: 300, start: 0.95, easing: backOut}}
            ...
            <div class="p-2">
                <input bind:this={input} on:input={search} on:keydown={handleKeydown} type="text"
                       class="w-full rounded-md border-0 bg-gray-200 px-4 py-2.5 text-gray-900 placeholder-gray-600 focus:ring-0 sm:text-sm dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-400"
