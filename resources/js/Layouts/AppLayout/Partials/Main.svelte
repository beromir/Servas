...
<div class="max-w-7xl mx-auto pb-12 sm:pt-4 sm:px-6 lg:px-8">
    ...
    {#if title}
        <div
            class="flex p-4 w-full justify-between items-center bg-white shadow-sm sm:px-0 sm:pt-0 sm:bg-transparent sm:border-b-2 sm:border-gray-300 sm:shadow-none dark:bg-gray-900 dark:border-gray-700">
            {#if title}
